  ...
  export const ActivityPackages = [
    // Drive
    {
      ...
      activityTemplates: [
        ...
        },
        {
          ...
          displayName: "Tạo folder",
          description: "Tạo a Google Drive folder in a given directory",
        ...
        },
        {
          ...
          displayName: "Tải lên file",
          description: "Tải lên a file from robot's file system to Google Drive",
          iconCode: "FaGoogleDrive",
          type: "activity",
        ...
        },
        {
          ...
          displayName: "Lấy file list in folder",
          description: "Lấy a list of files in a given folder in Google Drive",
          iconCode: "FaGoogleDrive",
          type: "activity",
        ...
        },
        {
          ...
          displayName: "Lấy a file/folder",
          description: "Lấy a file/folder in Google Drive",
          iconCode: "FaGoogleDrive",
          type: "activity",
        ...
        },
        {
          ...
          displayName: "Xóa file/folder",
          description: "Xóa a file/folder in Google Drive",
          iconCode: "FaGoogleDrive",
          type: "activity",
    ...
    // Gmail
    {
      ...
      activityTemplates: [
        ...
        },
        {
          ...
          description: "Gửi an email to other people using Gmail",
          iconCode: "FaEnvelope",
          type: "activity",
    ...
    //Sheets
    {
      ...
      activityTemplates: [
        ...
        },
        {
          ...
          displayName: "Tạo SpreadSheet",
          description: "Tạo SpreadSheet in Google Sheet",
        ...
        },
        {
          ...
          displayName: "Lấy SpreadSheet By Id",
          description: "Lấy SpreadSheet By Id in Google Sheet",
          iconCode: "FaFileSpreadsheet",
          type: "activity",
        ...
        },
        {
          ...
          displayName: "Xóa sheet",
          description: "Xóa sheet from a given SpreadSheet in Google Sheet",
          iconCode: "FaFileSpreadsheet",
          type: "activity",
        ...
        },
        {
          ...
          displayName: "Đọc Data From Sheet",
          description: "Đọc Data From Sheet in a given SpreadSheet in Google Sheet",
          iconCode: "FaFileSpreadsheet",
          type: "activity",
    ...
    // Classroom
    {
      ...
      activityTemplates: [
        ...
        },
        {
          ...
          displayName: "Tạo Course",
          description: "Tạo new course for teacher",
          type: "activity",
        ...
        },
        {
          ...
          displayName: "Xóa Classroom",
          description: "Xóa Classroom",
          type: "activity",
        ...
        },
        {
          ...
          displayName: "Lấy Course ID By Course Name",
          description: "Lấy ID of the course by course name",
          type: "activity",
        ...
        },
        {
          ...
          displayName: "Tạo Assignment",
          description: "Tạo Assignment in a course of Google Classroom",
          type: "activity",
        ...
        },
        {
          ...
          displayName: "Tạo Quiz",
          description: "Tạo Quiz in a course of Google Classroom",
          type: "activity",
          keyword: "Create Quiz",
          arguments: {
            "Course ID": {
        ...
        },
        {
          ...
          displayName: "Lấy Coursework ID By Title",
          description: "Lấy Coursework ID By Title",
          type: "activity",
        ...
        },
        {
          ...
          displayName: "Xóa Coursework",
          description: "Xóa Coursework",
          type: "activity",
        ...
        },
        {
          ...
          displayName: "Lấy Submission ID By Email",
          description: "Lấy Submission ID By Email",
          type: "activity",
    ...
    // Form
    {
      ...
      activityTemplates: [
        ...
        },
        {
          ...
          displayName: "Tạo Quiz Form",
          description: "Tạo quiz in google form",
          type: "activity",
          keyword: "Create Form",
          arguments: {
            "Form Name": {
        ...
        },
        {
          ...
          displayName: "Lấy Google Doc ID From URL",
          description: "Lấy Google Doc ID from URL",
          type: "activity",
    ...
    },
    {
      ...
      activityTemplates: [
        ...
        {
          templateId: "get_text",
          displayName: "Lấy text",
          description: "Lấy the text of a given element in the current browser tab",
          iconCode: "FaFont",
          type: "activity",
          keyword: "Get Text",
          arguments: {
      ...
      activityTemplates: [
        {
          ...
          displayName: "Tải lên file",
          description: "Tải lên a file to the platform's file storage",
        ...
        },
        {
          ...
          displayName: "Tải xuống file",
          description: "Tải xuống a file from the platform's file storage",
    ...
    },
    {
      ...
      activityTemplates: [
        ...
        },
        {
          ...
          displayName: "Lấy Business Partner",
        ...
        // Google Docs Integration
        {
          ...
          displayName: "Tạo Business Partner Address",
          description: "Tạo a new address for a business partner in the SAP system",
        ...
        },
        {
          ...
          displayName: "Cập nhật Business Partner Address",
          description: "Cập nhật an existing address for a business partner in the SAP system",
          iconCode: "FaEdit",
          type: "activity",
          ...
          return: {
            displayName: "Cập nhậtd Address Data",
            type: "object",
        ...
        // File Upload
        {
          ...
          displayName: "Xóa Business Partner Address",
          description: "Xóa an address for a business partner in the SAP system",
          iconCode: "FaTrash",
          type: "activity",
    ...
    },
    {
      _id: "rpa-erpnext",
      displayName: "ERPNext",
      description: "Automate procurement workflows in ERPNext (Item, MR, RFQ, PO)",
      library: "RPA.ERPNext",
      activityTemplates: [
        {
          ...
          arguments: {
            ...
            "Token File Path": {
              ...
              description: "The path to the file containing the ERPNext access token",
              keywordArg: "token_file_path",
              value: "",
            },
            "Verify SSL": {
        ...
        },
        {
          ...
          description: "Check if an Item exists in ERPNext; if not, create one automatically.",
          iconCode: "FaBox",
          type: "activity",
        ...
        // Assignment Management
        {
          ...
          displayName: "Tạo Material Request",
          description: "Tạo a Material Request document in ERPNext with multiple items.",
          ...
          arguments: {
            Items: {
              type: "list",
              description: "List of items to request. Each item must include item_code, qty, schedule_date",
              keywordArg: "items",
              value: [],
            },
          },
        ...
        },
        {
          ...
          displayName: "Tạo Request For Quotation (RFQ)",
          description: "Tạo an RFQ in ERPNext for one or more suppliers.",
        ...
        },
        {
          ...
          description: "Tạo a Purchase Order document in ERPNext for a supplier.",
        ...
        },
        {
          ...
          description: "Submit an existing ERPNext document (Material Request, RFQ, or Purchase Order).",
          ...
          arguments: {
            DocType: {
              type: "string",
              description: "The ERPNext doctype (e.g., Material Request, Request for Quotation, Purchase Order)",
              keywordArg: "doctype",
              value: "",
            },
            "Document ID": {
    ...
    // Moodle
    {
      ...
      activityTemplates: [
        ...
        // Course Category Management
        {
          ...
          displayName: "Lấy Course Categories",
          description: "Lấy list of all course categories",
        ...
        },
        {
          ...
          displayName: "Tạo Course Category",
          description: "Tạo a new course category",
          ...
          return: {
            ...
            type: "dictionary",
            description: "Tạod category information",
          },
        },
        {
        ...
        // Course Management
        {
          ...
          displayName: "Tạo Course",
          description: "Tạo a new course in Moodle",
          iconCode: "FaBook",
          type: "activity",
          keyword: "Create Course",
          arguments: {
          ...
          return: {
            displayName: "Course",
            type: "dictionary",
            description: "Tạod course information",
          },
        },
        {
          templateId: "moodle.get_course_by_shortname",
          displayName: "Lấy Course By Shortname",
          description: "Lấy course information by shortname",
          iconCode: "FaSearch",
          type: "activity",
        ...
        },
        {
          ...
          displayName: "Lấy Course Contents",
          description: "Lấy contents of a course",
          iconCode: "FaListAlt",
          type: "activity",
        ...
        // User Management
        {
          ...
          displayName: "Tạo User",
          description: "Tạo a new user in Moodle",
          iconCode: "FaUserPlus",
          type: "activity",
          keyword: "Create User",
          arguments: {
          ...
          return: {
            displayName: "User",
            type: "dictionary",
            description: "Tạod user information",
          },
        },
        {
        ...
        // Google Docs Integration
        {
          ...
          displayName: "Lấy Google Drive File ID From URL",
        ...
        },
        {
          ...
          displayName: "Đọc Google Doc Content",
          description: "Đọc text content from Google Docs",
          iconCode: "FaFileAlt",
          type: "activity",
        ...
        },
        {
          ...
          displayName: "Đọc Quiz From Google Doc",
        ...
        },
        {
          ...
          displayName: "Tạo Quiz From Google Doc",
          description: "Tạo quiz file from Google Doc",
        ...
        // File Upload
        {
          ...
          displayName: "Tải lên File To Moodle",
          description: "Tải lên a file to Moodle server",
          iconCode: "FaUpload",
          type: "activity",
          ...
          return: {
            ...
            type: "dictionary",
            description: "Tải lêned file information",
          },
        },
        // Bulk Operations
        {
        ...
        },
        {
          ...
          description: "Tạo multiple students at once",
          iconCode: "FaUsers",
          type: "activity",
        ...
        },
        {
          ...
          description: "Tạo multiple courses and enrol students",
        ...
        // Google Drive Integration
        {
          ...
          displayName: "Tải lên File To Google Drive",
          description: "Tải lên file to Google Drive",
          iconCode: "FaGoogleDrive",
          type: "activity",
          ...
          return: {
            displayName: "File Info",
            type: "dictionary",
            description: "Tải lêned file info with ID and links",
          },
        },
        {
          templateId: "moodle.download_file_from_google_drive",
          displayName: "Tải xuống File From Google Drive",
          description: "Tải xuống file from Google Drive",
          iconCode: "FaDownload",
          type: "activity",
        ...
        },
        {
          ...
          displayName: "Tạo Quiz And Upload To Drive",
          description: "Tạo quiz from Google Doc and upload to Drive",
          ...
          return: {
            displayName: "Tải lên Info",
            type: "dictionary",
            description: "Tải lên information with links",
          },
        },
        // User Lookup
        {
          templateId: "moodle.get_user_by_username",
          displayName: "Lấy User By Username",
          description: "Lấy user information by username",
        ...
        },
        {
          ...
          displayName: "Lấy User By Email",
          description: "Lấy user information by email address",
          iconCode: "FaEnvelope",
          type: "activity",
        ...
        },
        {
          ...
          displayName: "Lấy User By Username Or Email",
          description: "Lấy user by username or email (flexible search)",
          iconCode: "FaSearch",
          type: "activity",
        ...
        // Assignment Management
        {
          ...
          displayName: "Lấy Assignment ID From URL",
        ...
        },
        {
          ...
          displayName: "Lấy Assignment Instance ID From Course Module ID",
        ...
        },
        {
          ...
          displayName: "Tạo Submission For Student",
          description: "Tạo/submit assignment for a student",
          iconCode: "FaFileUpload",
          type: "activity",
        ...
        },
        {
          ...
          description: "Tạo submissions for multiple students",
          iconCode: "FaUsersCog",
          type: "activity",
        ...
        // Grade Upload and Export
        {
          ...
          displayName: "Tải lên Grades To Moodle",
          description: "Tải lên grades to Moodle assignment gradebook",
          iconCode: "FaCloudUploadAlt",
          type: "activity",
        ...
        },
        {
          ...
          description: "Tải xuống Excel from Drive, create students and courses",
          iconCode: "FaUsersCog",
          type: "activity",
        ...
        // Grading and Reporting
        {
          ...
          displayName: "Lấy Course Grades",
          description: "Lấy all student grades in a course",
          iconCode: "FaChartBar",
          type: "activity",
        ...
        },
        {
          ...
          displayName: "Lấy Assignment Submissions",
          description: "Lấy all student submissions for an assignment",
          iconCode: "FaFileAlt",
          type: "activity",
        ...
        },
        {
          ...
          displayName: "Lấy Assignment Grades",
          description: "Lấy grades for all students in an assignment",
          iconCode: "FaGraduationCap",
          type: "activity",
        ...
        },
        {
          ...
          displayName: "Lấy Course Enrolled Users",
          description: "Lấy all users enrolled in a course",
          iconCode: "FaUsers",
          type: "activity",
        ...
        },
        {
          ...
          displayName: "Lấy Course Activity Completion",
          description: "Lấy activity completion status for course",
          iconCode: "FaTasks",
          type: "activity",
        ...
        },
        {
          ...
          displayName: "Lấy Course Statistics",
          description: "Lấy comprehensive statistics about a course",
          iconCode: "FaChartPie",
          type: "activity",
