...
import { ActivityPackageResponseDto } from 'src/activity-packages/dto/activity-package-response.dto';
...
export class ProcessesValidateService {
  private activityPackages: ActivityPackageResponseDto[] = [];

  constructor(
    private readonly connectionService: ConnectionService,
    private readonly activityPackagesService: ActivityPackagesService,
  ) {
    this.activityPackagesService.findAll().then((packages) => {
